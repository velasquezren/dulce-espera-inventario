...
export const CANALES: readonly Canal[] = [
  {
    ...
    nombreCorto: 'Mercado',
    descripcion: 'Perecederos: verduras, frutas, carnes y tuberculos',
    tono: 'alerta',
    color: '#b45309',
  },
  {
    ...
    descripcion: 'Secos, enlatados, lacteos industriales y limpieza',
    tono: 'marca',
    color: '#006156',
  },
  {
    ...
    descripcion: 'Distribuidoras, formulas clinicas y contratos',
    tono: 'info',
    color: '#4338ca',
  },
  {
    ...
    nombreCorto: 'Otros',
    descripcion: 'Panaderia diaria, descartables y misceláneos',
    tono: 'neutral',
    color: '#475569',
  },
];
