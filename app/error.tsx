  ...
  return (
    <div className="flex min-h-[100dvh] flex-col items-center justify-center gap-5 bg-canvas px-6 text-center">
      ...
      <div className="max-w-sm">
        <h1 className="text-lg font-semibold tracking-tight text-ink">No se pudo mostrar esta seccion</h1>
        <p className="mt-2 text-[13px] leading-relaxed text-ink-muted">
          Ocurrio un error inesperado. Puedes reintentar; si el problema continua, avisa al area de sistemas.
        </p>
